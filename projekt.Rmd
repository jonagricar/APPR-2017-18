...
5. `bdp.slo` - podatki o deležu bdp-ja za področje športa za obdobje 2000-2016
  * `leto` - spremenljivka:  leta od 2000 do 2016 (integer),
  * `drzava` - spremenljivka: evropske države (character),
  * `delez` - meritev: delez bdp za posamezno državo (numeric).
